...
public class ByVolumePrice implements PriceStrategy {
    private final static Map<Material, Double> prices = new EnumMap<>(Material.class);
    static {
    ...
    public double price(BuildingElement buildingElement) {
        return buildingElement.getDimensions().volume() * prices.get(buildingElement.getMaterial());
    }
}
